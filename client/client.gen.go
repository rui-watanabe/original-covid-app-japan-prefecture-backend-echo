...
func (c *Client) Get(ctx context.Context) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	// Get request
	GetWithResponse(ctx context.Context) (*GetResponse, error)
}
...
func (c *ClientWithResponses) GetWithResponse(ctx context.Context) (*GetResponse, error) {
	rsp, err := c.Get(ctx)
	if err != nil {
		return nil, err
	}
